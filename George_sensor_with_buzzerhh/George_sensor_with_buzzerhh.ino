...
#define RPM 36
#define MICROSTEPS 1
#define FDEGREES 320 // how many degrees to rotate in a forward (infusion) direction 
#define BDEGREES 160 // how many degrees to rotate in a backward (withdrawal) direction 
...
const uint16_t BUZZER_INTERVAL = 500;
